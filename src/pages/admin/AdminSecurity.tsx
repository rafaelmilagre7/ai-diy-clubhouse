  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background/95 to-destructive/5 p-6 space-y-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-60 left-20 w-96 h-96 bg-gradient-to-br from-orange-500/6 to-yellow-500/3 rounded-full blur-3xl animate-blob animation-delay-2000"></div>
      ...
      <div className="space-y-8">
        ...
        <div className="aurora-glass rounded-2xl border border-orange-500/20 backdrop-blur-md overflow-hidden animate-fade-in animation-delay-500">
          <div className="bg-gradient-to-r from-orange-500/10 via-red-500/5 to-transparent p-8 border-b border-orange-500/20">
            <div className="flex items-center gap-4">
