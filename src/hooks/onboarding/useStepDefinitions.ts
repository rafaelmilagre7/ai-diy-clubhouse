...
export const steps = [
  ...
  { id: 'business_goals', title: 'Expectativas e Objetivos com o Club', section: 'business_goals', path: '/onboarding/club-goals' },
  ...
  { id: 'complementary_info', title: 'Informações Complementares', section: 'complementary_info', path: '/onboarding/complementary' },
  { id: 'review', title: 'Revisar e Finalizar', section: 'review', path: '/onboarding/review' }
];
