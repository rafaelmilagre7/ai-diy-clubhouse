...
export const ImplementationNavigation = ({ 
  ...
  return (
    <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 shadow-2xl">
      <h3 className="text-lg font-semibold mb-6 bg-gradient-to-r from-white to-viverblue-light bg-clip-text text-transparent">
          ...
          return (
            <button
              ...
              className={cn(
                ...
                isCurrent && "bg-viverblue/20 border border-viverblue/30",
