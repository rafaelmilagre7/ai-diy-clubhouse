...
export const ConversionChart: React.FC<ConversionChartProps> = ({ data }) => {
  const channels = [
    { name: 'Email', ...data.email, color: 'bg-blue-500' },
    { name: 'WhatsApp', ...data.whatsapp, color: 'bg-green-500' }
  ];
            ...
            <div className="space-y-2">
              ...
              <div className="w-full bg-gray-200 rounded-full h-3">
                <div 
                  ...
                  style={{ width: `${maxConversion > 0 ? (channel.conversionRate / maxConversion) * 100 : 0}%` }}
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div 
                  ...
                  style={{ width: `${Math.min((channel.roi / 20) * 100, 100)}%` }}
                />
              </div>
            </div>
