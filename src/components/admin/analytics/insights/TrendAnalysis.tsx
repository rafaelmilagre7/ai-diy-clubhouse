...
export const TrendAnalysis: React.FC<TrendAnalysisProps> = ({ timeRange }) => {
  ...
  const trendData = [
    { month: 'Jan', usuarios: 120, implementacoes: 85, receita: 38000 },
    { month: 'Fev', usuarios: 135, implementacoes: 92, receita: 41000 },
    { month: 'Mar', usuarios: 142, implementacoes: 88, receita: 43500 },
    { month: 'Abr', usuarios: 158, implementacoes: 95, receita: 45000 },
    { month: 'Mai', usuarios: 165, implementacoes: 102, receita: 48500 },
    { month: 'Jun', usuarios: 172, implementacoes: 98, receita: 52000 }
  ];
