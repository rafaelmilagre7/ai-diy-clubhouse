...
export const PerformanceScore: React.FC<PerformanceScoreProps> = ({ timeRange }) => {
  ...
  const getScoreStatus = (score: number) => {
    ...
    if (score >= 60) return { status: 'warning', color: 'text-orange-600', bg: 'bg-orange-50' };
        ...
        <div className={cn("p-6 rounded-xl border-2", scoreInfo.bg)}>
          ...
          <Progress 
            ...
            indicatorClassName={cn(
              ...
              overallScore >= 75 && overallScore < 90 && "bg-blue-500",
              overallScore >= 60 && overallScore < 75 && "bg-orange-500",
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Badge 
                    ...
                    className={cn(
                      ...
                      metric.status === 'warning' && "border-orange-200 text-orange-700",
                      metric.status === 'critical' && "border-red-200 text-red-700"
                    )}
                  >
                    {metric.status}
                  </Badge>
