...
import { UsersIcon, CheckCircle, AlertCircle, Clock, AlertTriangle } from "lucide-react"
import {
  Table,
  TableBody,
  TableCell,
        ...
        <TableRow>
          <TableCell colSpan={7} className="h-24 text-center">
            <div className="flex flex-col items-center justify-center">
              ...
              <p className="text-muted-foreground">Nenhum usuário com onboarding encontrado</p>
            </div>
          </TableCell>
        </TableRow>
      );
            ...
            <div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-1 mt-2">
                  ...
                  {Object.entries(stats.usersByStep).length > 0 ? (
      ...
      <Card className="p-6">
        ...
        {stats.users && stats.users.length > 0 ? (
          ...
          <Alert>
            ...
            <AlertDescription>
              Não foram encontrados dados de onboarding no sistema.
            </AlertDescription>
          </Alert>
        )}
      </Card>
