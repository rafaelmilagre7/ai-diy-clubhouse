...
const SolutionEditorHeader: React.FC<SolutionEditorHeaderProps> = ({
  ...
  return <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 p-4 rounded-lg shadow-sm bg-gray-800">
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          {difficulty && <div className="flex items-center mt-1">
              <span className={`${difficultyColor || 'bg-gray-500'} text-white text-xs px-2 py-0.5 rounded-full`}>
