...
export const BusinessContextFormStep: React.FC<BusinessContextFormStepProps> = ({
  progress,
  onSave
}) => {
  ...
  return <FormProvider {...methods}>
      <form onSubmit={methods.handleSubmit(handleSubmit)} className="space-y-6">
        <div className="rounded-lg p-6 shadow-sm space-y-8 bg-gray-900">
          <BusinessModelField control={methods.control} error={methods.formState.errors.business_model} />
          
          <BusinessChallengesField control={methods.control} error={methods.formState.errors.business_challenges} />
          
          <ShortTermGoalsField control={methods.control} error={methods.formState.errors.short_term_goals} />
          
          <MediumTermGoalsField control={methods.control} error={methods.formState.errors.medium_term_goals} />
          
          <KpisField control={methods.control} error={methods.formState.errors.important_kpis} />
          
          <AdditionalContextField control={methods.control} error={methods.formState.errors.additional_context} />
          
          <NavigationButtons isSubmitting={methods.formState.isSubmitting} onPrevious={handlePreviousStep} submitText="Continuar" loadingText="Salvando..." />
        </div>
      </form>
    </FormProvider>;
};