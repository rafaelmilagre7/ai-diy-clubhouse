...
export const useDirectOnboardingAdapter = () => {
  ...
  const mapFrontendToBackend = useCallback((frontendData: any): OnboardingData => {
    ...
    return {
      ...
      // Step 3 - Experiência com IA (dados diretos do formData)
      has_implemented_ai: frontendData.hasImplementedAI,
      ai_tools_used: frontendData.aiToolsUsed || [],
      ai_knowledge_level: frontendData.aiKnowledgeLevel,
      who_will_implement: frontendData.whoWillImplement,
      ai_implementation_objective: frontendData.aiImplementationObjective,
      ai_implementation_urgency: frontendData.aiImplementationUrgency,
      ai_main_challenge: frontendData.aiMainChallenge,
      
      // Step 4 - Objetivos (dados diretos do formData)
      main_objective: frontendData.mainObjective,
      area_to_impact: frontendData.areaToImpact,
      expected_result_90_days: frontendData.expectedResult90Days,
      urgency_level: frontendData.urgencyLevel,
      success_metric: frontendData.successMetric,
      main_obstacle: frontendData.mainObstacle,
      preferred_support: frontendData.preferredSupport,
      ai_implementation_budget: frontendData.aiImplementationBudget,
      
      // Step 5 - Personalização (dados diretos do formData)
      weekly_learning_time: frontendData.weeklyLearningTime,
      best_days: frontendData.bestDays || [],
      best_periods: frontendData.bestPeriods || [],
      content_preference: frontendData.contentPreference || [],
      content_frequency: frontendData.contentFrequency,
      wants_networking: frontendData.wantsNetworking,
      community_interaction_style: frontendData.communityInteractionStyle,
      preferred_communication_channel: frontendData.preferredCommunicationChannel,
      follow_up_type: frontendData.followUpType,
      motivation_sharing: frontendData.motivationSharing,
