...
const OnboardingCompleted = () => {
  ...
  // Timeout para o loading - se demorar muito, mostrar a página mesmo assim
  useEffect(() => {
    const timer = setTimeout(() => {
      if (isLoading) {
        console.log("[OnboardingCompleted] Timeout de loading atingido, forçando exibição");
  ...
  // Se ainda está carregando e não passou do timeout, mostrar loading
