...
const VideoPlayer: React.FC<VideoPlayerProps> = ({ 
    ...
    if (!videoId) {
      ...
      return (
        <div className="aspect-video bg-slate-100 flex items-center justify-center rounded-md">
          <p className="text-slate-500 text-sm">Erro ao processar vídeo Panda. URL inválida.</p>
        </div>
      );
    }
  ...
  // Vídeo do YouTube
    ...
    if (youtubeId) {
      ...
      return (
        <div className="aspect-video bg-slate-100 flex items-center justify-center rounded-md">
          <p className="text-slate-500 text-sm">Erro ao processar vídeo do YouTube. URL inválida.</p>
        </div>
      );
    }
  }
  ...
  if (!videoUrl) {
    return (
      <div className="aspect-video bg-slate-100 flex items-center justify-center rounded-md">
        <p className="text-slate-500 text-sm">Nenhuma URL de vídeo fornecida.</p>
      </div>
    );
  }
