      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <Button
            ...
            className="justify-start h-12 bg-social-linkedin hover:bg-social-linkedin-hover text-primary-foreground shadow-md hover:shadow-lg transition-smooth hover:scale-105"
          >
          ...
          <Button
            ...
            className="justify-start h-12 bg-social-twitter hover:bg-social-twitter-hover text-primary-foreground shadow-md hover:shadow-lg transition-smooth hover:scale-105"
          >
            <svg className="h-5 w-5 mr-3" viewBox="0 0 24 24" fill="currentColor">
          ...
          <Button
            ...
            className="justify-start h-12 bg-social-whatsapp hover:bg-social-whatsapp-hover text-primary-foreground shadow-md hover:shadow-lg transition-smooth hover:scale-105"
          >
            <svg className="h-5 w-5 mr-3" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <Button
            ...
            className="justify-start h-10 hover:bg-muted/50 transition-smooth"
          >
