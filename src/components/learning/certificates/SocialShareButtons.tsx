      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <Button
            ...
            className="justify-start h-12 bg-[#0077B5] hover:bg-[#005885] text-white shadow-md hover:shadow-lg transition-all duration-200 hover:scale-105"
          >
          ...
          <Button
            ...
            className="justify-start h-12 bg-black hover:bg-gray-800 text-white shadow-md hover:shadow-lg transition-all duration-200 hover:scale-105"
          >
            <svg className="h-5 w-5 mr-3" viewBox="0 0 24 24" fill="currentColor">
          ...
          <Button
            ...
            className="justify-start h-12 bg-[#25D366] hover:bg-[#1DA851] text-white shadow-md hover:shadow-lg transition-all duration-200 hover:scale-105"
          >
            <svg className="h-5 w-5 mr-3" viewBox="0 0 24 24" fill="currentColor">
