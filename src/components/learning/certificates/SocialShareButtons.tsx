      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <Button
            ...
            className="justify-start h-12 bg-[hsl(var(--social-linkedin))] hover:bg-[hsl(var(--social-linkedin-hover))] text-white shadow-md hover:shadow-lg transition-all duration-200 hover:scale-105"
          >
          ...
          <Button
            ...
            className="justify-start h-12 bg-[hsl(var(--social-twitter))] hover:bg-[hsl(var(--social-twitter-hover))] text-white shadow-md hover:shadow-lg transition-all duration-200 hover:scale-105"
          >
            <svg className="h-5 w-5 mr-3" viewBox="0 0 24 24" fill="currentColor">
          ...
          <Button
            ...
            className="justify-start h-12 bg-[hsl(var(--social-whatsapp))] hover:bg-[hsl(var(--social-whatsapp-hover))] text-white shadow-md hover:shadow-lg transition-all duration-200 hover:scale-105"
          >
            <svg className="h-5 w-5 mr-3" viewBox="0 0 24 24" fill="currentColor">
