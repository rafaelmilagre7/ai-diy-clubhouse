      ...
      <Card className="bg-gradient-to-br from-viverblue/20 to-purple-900/20 border-viverblue/30 overflow-hidden">
        <CardContent className="p-8 relative">
          ...
          <div className="absolute inset-0 opacity-5">
            <div className="w-full h-full bg-[url('data:image/svg+xml,%3Csvg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg fill="%23ffffff" fill-opacity="0.1"%3E%3Ccircle cx="30" cy="30" r="4"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] repeat"></div>
          </div>
