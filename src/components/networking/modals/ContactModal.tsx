              ...
              <div className="relative p-6 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  {card.whatsappNumber && (
                    <div className="space-y-2">
                      <label className="text-xs font-semibold text-muted-foreground flex items-center gap-2 uppercase tracking-wide">
                        <div className="p-1.5 rounded-md bg-social-whatsapp/10">
                          <Phone className="h-3.5 w-3.5 text-social-whatsapp" />
                        </div>
                        WhatsApp
                      </label>
                      <div className="flex gap-2">
                  ...
                  {card.linkedinUrl && (
                    <div className="space-y-2">
                      <label className="text-xs font-semibold text-muted-foreground flex items-center gap-2 uppercase tracking-wide">
                        <div className="p-1.5 rounded-md bg-social-linkedin/10">
                          <Linkedin className="h-3.5 w-3.5 text-social-linkedin" />
                        </div>
                        LinkedIn
                      </label>
                      <Button
