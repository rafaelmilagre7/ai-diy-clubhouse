...
export const CertificatePreview = ({
  ...
  return (
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="fixed -left-[10000px] top-0 w-[1123px] h-[850px] pointer-events-none opacity-0">
        ...
        <div className="relative">
          <div className="relative">
            ...
            <div 
              ...
              style={{ width: `${1123 * scale}px`, height: `${850 * scale}px` }}
            >
              {/* Container real em tamanho 1:1, só com transform visual */}
              <div
                ref={previewRef}
                className="w-[1123px] h-[850px] origin-top-left"
                style={{
