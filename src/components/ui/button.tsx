...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-glow-primary hover:shadow-glow-primary-strong",
        destructive: "bg-error text-white hover:bg-error/90 shadow-sm",
        outline: "border border-border bg-transparent hover:bg-surface-hover hover:border-border-strong",
        secondary: "bg-surface-elevated text-text-secondary hover:bg-surface-hover border border-border",
        ...
        gradient: "bg-gradient-primary text-white hover:opacity-90 shadow-glow-primary",
      },
      size: {
