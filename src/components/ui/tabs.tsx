...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-md bg-[#151823] p-1 text-white border border-neutral-700/50 shadow-inner",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=active]:bg-viverblue/10 data-[state=active]:text-viverblue data-[state=active]:shadow-sm data-[state=active]:font-semibold",
