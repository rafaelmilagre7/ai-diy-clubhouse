...
function AppContent() {
  ...
  useEffect(() => {
    ...
    console.log('[APP-CONTENT] Estado da aplicação:', {
      hasUser: !!user,
      isLoading,
      error,
  ...
  if (error) {
    console.error('[APP-CONTENT] Erro crítico na aplicação:', error);
    return (
  ...
  console.log('[APP-CONTENT] Renderizando RouterProvider');
