...
-- 2. Criar nova política que inclui course_access_control (sem created_by que não existe)
...
INSERT INTO public.audit_logs (
  ...
  jsonb_build_object(
    ...
    'correction', 'Added course_access_control verification for hands_on/membro_club roles',
    'affected_roles', '["hands_on", "membro_club"]',
    'expected_result', 'Users should now see modules and lessons in Formação section'
  ),
  'info'
);