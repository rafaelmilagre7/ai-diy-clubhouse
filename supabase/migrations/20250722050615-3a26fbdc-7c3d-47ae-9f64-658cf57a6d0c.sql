...
DROP FUNCTION IF EXISTS public.create_invite_hybrid(text, uuid, text, interval, text, text);
DROP FUNCTION IF EXISTS public.create_invite_hybrid(text, uuid, text, text, text, text);

-- Criar função limpa e única
