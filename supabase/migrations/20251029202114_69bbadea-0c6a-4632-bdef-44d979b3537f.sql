-- =====================================================
-- Função SECURITY DEFINER para UPSERT de progresso de aulas
-- Resolve erro 404 e 42P01 ao bypassar RLS durante FK validation
-- =====================================================
...
BEGIN
  ...
  -- 2. Validar que a aula existe (BYPASS RLS)
...
'Função SECURITY DEFINER para INSERT/UPDATE seguro de progresso de aulas. Bypassa RLS para evitar erros de FK validation e 404.';