...
-- 2. Atualizar constraints de foreign key
...
-- 3. Atualizar triggers existentes
...
-- 4. Criar novas funções RPC padronizadas
...
-- 5. Manter aliases para compatibilidade temporária
...
-- 6. Atualizar realtime subscriptions
