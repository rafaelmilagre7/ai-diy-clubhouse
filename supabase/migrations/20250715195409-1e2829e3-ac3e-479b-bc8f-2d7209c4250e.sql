-- CORREÇÃO COMPLETA DO FLUXO DE CONVITES - PARTE 2: FUNÇÕES E TRIGGERS

-- 1. Criar função get_user_profile_safe melhorada
...
-- 2. Melhorar trigger de criação automática de perfil
