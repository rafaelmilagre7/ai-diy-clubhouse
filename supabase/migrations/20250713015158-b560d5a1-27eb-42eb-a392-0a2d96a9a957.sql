-- Corrigir a função get_courses_with_stats para ter a ordem correta das colunas
...
AS $function$
  SELECT 
    ...
    CASE
      WHEN course_access.course_id IS NOT NULL THEN true
      ELSE false
  ...
  LEFT JOIN course_access_control course_access ON lc.id = course_access.course_id
