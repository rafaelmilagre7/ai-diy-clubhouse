-- FASE 1: Corrigir problemas críticos de banco de dados
...
-- 2. Corrigir view solutions que está causando erro s.created_at
DROP VIEW IF EXISTS public.solutions;
CREATE VIEW public.solutions AS
SELECT 
...
-- 3. Recriar admin_analytics_overview corrigindo o problema s.created_at
...
SELECT 
  ...
  0 as total_solutions, -- placeholder fixo
  0 as new_solutions_30d, -- placeholder fixo
...
-- 4. Habilitar RLS na tabela quick_onboarding
ALTER TABLE public.quick_onboarding ENABLE ROW LEVEL SECURITY;

-- 5. Criar políticas RLS para quick_onboarding
