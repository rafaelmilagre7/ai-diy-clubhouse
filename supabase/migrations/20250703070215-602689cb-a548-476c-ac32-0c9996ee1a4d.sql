-- CORREÇÃO ESPECÍFICA DA VIEW user_segmentation_analytics
-- Fix da referência ambígua ao user_id
...
INSERT INTO public.audit_logs (
  ...
  NULL,
  'security_fix',
  'user_segmentation_analytics_ambiguity_fix',
  jsonb_build_object(
    'view_corrected', 'user_segmentation_analytics',
    'issue_fixed', 'Referência ambígua ao user_id corrigida',
    'security_type', 'SECURITY INVOKER (padrão)',
    'timestamp', NOW()
  )
);