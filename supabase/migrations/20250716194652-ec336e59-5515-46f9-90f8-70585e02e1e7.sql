-- FASE 1: Correção RLS Crítica (Corrigida)

-- 1. Criar função admin segura alternativa
...
-- 2. Remover views Security Definer problemáticas
...
-- 3. Criar função para substituir learning_courses_with_stats
...
INSERT INTO public.audit_logs (
  ...
  jsonb_build_object(
    'message', 'FASE 1 - Views recursivas removidas, função admin segura criada',
    'phase', '1_complete',
    'next_phase', 'phase_2_onboarding_simplification',
    'timestamp', now()
  ),
  auth.uid()
);