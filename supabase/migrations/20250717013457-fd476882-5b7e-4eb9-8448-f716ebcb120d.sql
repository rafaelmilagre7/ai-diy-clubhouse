-- CORREÇÃO URGENTE: Função initialize_onboarding_for_user e inicialização em massa
-- ==================================================================

-- 1. Corrigir função initialize_onboarding_for_user para usar apenas campos JSONB
...
-- 2. Inicialização em massa para usuários órfãos
INSERT INTO public.onboarding_final (
  user_id,
  current_step,
  completed_steps,
