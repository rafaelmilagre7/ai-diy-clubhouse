-- FASE 2: CORREÇÃO DE ANONYMOUS ACCESS POLICIES CRÍTICAS (FINAL CORRIGIDO)
...
-- tools (manter público mas apenas status ativo)
...
INSERT INTO public.audit_logs (
  ...
  'security_hardening',
  'phase_2_anonymous_policies_fix_final',
  jsonb_build_object(
    'message', 'FASE 2 - Correção de políticas de acesso anônimo (final)',
