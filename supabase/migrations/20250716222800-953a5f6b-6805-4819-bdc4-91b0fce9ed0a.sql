-- ==========================================
-- CORREÇÃO CRÍTICA: FUNÇÃO create_invite_hybrid
-- ==========================================

-- 🎯 CORREÇÃO: Corrigir ordem dos parâmetros na função create_invite_hybrid
