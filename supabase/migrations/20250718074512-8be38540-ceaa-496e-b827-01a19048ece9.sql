-- FASE 2: CORREÇÃO DE ANONYMOUS ACCESS POLICIES CRÍTICAS (CORRIGIDO)
...
-- solutions (manter público - sem coluna status, mantendo acesso total por enquanto)
DROP POLICY IF EXISTS "solutions_select_policy" ON public.solutions;
CREATE POLICY "solutions_public_access" ON public.solutions
...
INSERT INTO public.audit_logs (
  ...
  'security_hardening',
  'phase_2_anonymous_policies_fix_corrected',
  jsonb_build_object(
    'message', 'FASE 2 - Correção de políticas de acesso anônimo (corrigido)',
