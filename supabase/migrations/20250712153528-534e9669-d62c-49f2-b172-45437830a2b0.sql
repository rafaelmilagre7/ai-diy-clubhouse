-- Migration: Fix search_path vulnerabilities - Complete batch for all remaining functions
-- Adding SET search_path = '' to all functions missing this security setting

-- 1. Fix get_courses_with_stats function
...
-- 2. Fix log_permission_change function
...
-- 3. Fix get_lessons_with_relations function
...
-- 4. Fix check_solution_certificate_eligibility function
...
-- 5. Fix get_user_security_permissions function
...
-- 6. Fix log_security_event function
...
-- 7. Fix create_solution_certificate_if_eligible function
...
-- 8. Fix create_learning_certificate_if_eligible function
...
-- 9. Fix process_referral function
...
-- 10. Fix generate_retroactive_certificates function
