...
-- FASE 1: Garantir que o campo ai_assistant_id existe na tabela learning_lessons
...
-- FASE 2: Corrigir view learning_courses_with_stats para garantir compatibilidade de tipos
...
-- FASE 3: Corrigir view learning_lessons_with_relations para incluir ai_assistant_id
...
-- FASE 4: Atualizar função get_courses_with_stats
...
-- FASE 5: Atualizar função get_lessons_with_relations
...
-- FASE 6: Criar índices adicionais para performance se não existirem
