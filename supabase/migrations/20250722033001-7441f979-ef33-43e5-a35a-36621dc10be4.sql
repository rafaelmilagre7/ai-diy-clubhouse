-- Corrigir sistema de comentários e likes das aulas
...
-- 4. Habilitar realtime para atualizações automáticas
ALTER PUBLICATION supabase_realtime ADD TABLE learning_comments;
