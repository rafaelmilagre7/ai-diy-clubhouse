-- Limpeza completa de todas as versões conflitantes de get_users_with_filters_v2
-- Esta migração resolve definitivamente o erro de ambiguidade de função

-- Dropar TODAS as versões possíveis (independente da ordem dos parâmetros)
...
-- Criar ÚNICA versão definitiva com ordem consistente
-- Ordem: (p_search_query, p_filter_type, p_limit, p_offset)
-- Esta é a ordem que o código TypeScript espera
