-- Corrigir função create_invite_hybrid para não criar perfils prematuramente
-- Remove a criação de perfil que estava causando erro de foreign key constraint
...
BEGIN
  ...
  -- Criar APENAS o convite - o perfil será criado automaticamente pelo trigger handle_new_user
