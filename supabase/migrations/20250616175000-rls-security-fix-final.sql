...
SELECT enable_rls_if_table_exists('suggestions');
SELECT enable_rls_if_table_exists('tools');
SELECT enable_rls_if_table_exists('trusted_domains');
...
SELECT enable_rls_if_table_exists('permission_definitions');
SELECT enable_rls_if_table_exists('permission_audit_logs');
SELECT enable_rls_if_table_exists('solutions');
SELECT enable_rls_if_table_exists('solution_tools_reference');
...
SELECT enable_rls_if_table_exists('badges');
SELECT enable_rls_if_table_exists('benefit_access_control');
SELECT enable_rls_if_table_exists('benefit_clicks');
SELECT enable_rls_if_table_exists('communication_deliveries');
SELECT enable_rls_if_table_exists('community_reports');
SELECT enable_rls_if_table_exists('connection_notifications');
SELECT enable_rls_if_table_exists('connection_recommendations');
