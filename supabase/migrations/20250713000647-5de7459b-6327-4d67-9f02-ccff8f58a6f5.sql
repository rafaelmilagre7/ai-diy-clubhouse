-- Correção dos erros de Security Definer Views - Abordagem por Partes
-- Remover SECURITY DEFINER das views problemáticas

-- 1. Dropar e recriar views que têm conflitos de coluna
...
-- 2. Recriar views básicas sem SECURITY DEFINER
...
-- 3. Recriar views de aprendizado sem SECURITY DEFINER
...
-- 4. Views de métricas de usuário
...
-- 5. Recriar view de benefícios sem SECURITY DEFINER
...
INSERT INTO public.audit_logs (
  ...
  'fix_security_definer_views_partial',
  jsonb_build_object(
    'message', 'Corrigidas views principais removendo SECURITY DEFINER',
    'phase', 1,
    'views_corrected', ARRAY[
