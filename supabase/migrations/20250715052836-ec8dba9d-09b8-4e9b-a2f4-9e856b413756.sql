...
-- Identificar e criar perfis para usuários que aceitaram convites

-- Função para corrigir convites órfãos
  ...
  LOOP
    ...
    IF invite_record.id IS NOT NULL THEN
      INSERT INTO public.profiles (
        ...
        user_record.email->>'name' OR user_record.email->>'full_name',
