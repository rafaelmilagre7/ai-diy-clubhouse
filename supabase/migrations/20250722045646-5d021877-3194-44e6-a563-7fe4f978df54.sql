-- Criar tabela learning_lesson_nps se não existir
...
DROP POLICY IF EXISTS "Users can view their own NPS responses" ON public.learning_lesson_nps;
DROP POLICY IF EXISTS "Users can create their own NPS responses" ON public.learning_lesson_nps;
DROP POLICY IF EXISTS "Admins can view all NPS responses" ON public.learning_lesson_nps;
