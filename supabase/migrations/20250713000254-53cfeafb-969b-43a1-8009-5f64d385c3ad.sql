-- Correção dos erros de Security Definer Views - Versão Corrigida
...
-- Recriar view sem SECURITY DEFINER mantendo estrutura original
...
-- 2. Recriar views de usuário sem SECURITY DEFINER
...
-- 3. Recriar views administrativas com RLS apropriado
...
-- 4. Recriar views de aprendizado sem SECURITY DEFINER
...
-- 5. Views de métricas de performance
...
-- 6. Views de engajamento e métricas de usuário
...
-- 7. View de benefícios sem SECURITY DEFINER
...
INSERT INTO public.audit_logs (
  ...
  jsonb_build_object(
    'message', 'Corrigidas 25 views com SECURITY DEFINER - removido security definer de todas as views',
    'views_fixed', 25,
    'security_improvement', 'Views agora executam com permissões do usuário atual'
  )
);