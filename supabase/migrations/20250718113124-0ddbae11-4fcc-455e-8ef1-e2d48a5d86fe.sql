-- CORREÇÃO: Dropar função conflitante primeiro
DROP FUNCTION IF EXISTS public.increment_topic_views(uuid);
...
INSERT INTO public.audit_logs (
  ...
  'security_hardening',
  'phase_6_lote_3_final_massive_fix_corrected',
  jsonb_build_object(
    'message', 'FASE 6 - Lote 3 FINAL: Correção massiva das últimas funções search_path (corrigido)',
    'functions_fixed', 30,
    ...
    'completion_status', 'final_batch_complete_corrected',
