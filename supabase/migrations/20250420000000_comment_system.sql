...
-- Tabela para comentários de ferramentas
...
-- Função para incrementar um contador em qualquer tabela/coluna
...
-- Função para decrementar um contador em qualquer tabela/coluna
