-- Migration: Fix search_path vulnerabilities for existing functions only
-- Adding SET search_path = '' to functions that actually exist

-- 1. Core authentication and security functions
...
INSERT INTO public.audit_logs (
  ...
  jsonb_build_object(
    ...
    'status', 'Successfully applied search_path fixes'
  )
);